...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
     ...
     <div class="row">
        <div class="col-md-3 listpage"><h4>Manage State</h4></div>
        ...
        <div class="col-md-3"><p style="text-align:right">
          <span><input type="button" name="add" value="Add State"  class="button" onclick="location.href='state-addf.php'" /></span>  
          </p>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <form name="frm" method="post" action="state-del.php" enctype="multipart/form-data">
              <div class="box">
                <div class="box-body">
                  <table id="state-grid" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        <th width="50px">
                    ...
                    <tbody>
                      ...
                      $sql=$obj->query("select * from $tbl_state where 1=1 order by state asc",$debug=-1);
                      ...
                      while($line=$obj->fetchNextObject($sql)){?>
                        <tr>
                          ...
                          <td><?php echo ucfirst(stripslashes($line->state)); ?></td>
                          <td align="center">
                           <label class="switch">
                              <input type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?>  data-one="<?php echo $tbl_state?>">
                              <div class="slider round"></div>
                            </label>
                          </td>
                          <td><a href="state-addf.php?id=<?php echo $line->id;?>" class="btn btn-primary" title="edit"> <i class="fa fa-pencil"></i></a>
                          </td>
                        </tr>
                        <?php $i++; }?>
                      </tbody>
