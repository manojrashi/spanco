 ...
 <?php include("menu.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="row">
      	<div class="col-md-3"><h4>Manage Employee</h4></div>
      	...
      	<div class="col-md-3"><p style="text-align:right">
      		<span><input type="button" name="add" value="Add Employee"  class="button btn-success" onclick="location.href='employee-addf.php'" /></span>	
      		</p>
      	</div>
      </div>
    </section>
          ...
          <div class="box box-primary">
            <div class="box-body">
              <table id="company-grid" class="table table-bordered table-striped">
				...
				$sql=$obj->query("select * from $tbl_user where 1=1 order by id desc limit 0,50",$debug=-1);
				
				while($line=$obj->fetchNextObject($sql)){?>
                <tr bgcolor="<?php echo $bgcolor;?>">
					<td><?php echo $i; ?></td>
					<td><?php echo strtoupper(stripslashes($line->empname));?></td>
					<td align="center">
					<label class="switch">
						<input type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?>  data-one="<?php echo $tbl_user?>">
						<div class="slider round"></div>
						</label>
					</td>
					<td>
						<a href="employee-addf.php?id=<?php echo $line->id;?>" class="btn btn-primary" title="edit"><i class="fa fa-pencil"></i></a> 
					</td>
