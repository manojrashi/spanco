 ...
 <?php include("menu.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
       <div class="row">
      	<div class="col-md-4 listpage"><h4>Newsletter Templates</h4></div>
      	...
      	<div class="col-md-3"><p style="text-align:right">
      		<span><input type="button" name="add" value="Add Newsletter Template"  class="button" onclick="location.href='newsletter_template-addf.php'" /></span>	
      		</p>
      	</div>
      </div>
    </section>
          ...
          <div class="box">
            <div class="box-body">
              <table id="faq-grid" class="table table-bordered table-striped">
				...
				<?php
				$i=1;
				$sql=$obj->query("select * from $tbl_newsletter_template where 1=1",$debug=-1);
                ...
                <tr>
					...
					<td align="center">
          <label class="switch">
                  <input type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?>  data-one="<?php echo $tbl_newsletter_template?>">
                  <div class="slider round"></div>
                </label>
                </td> 
			          <td><a href="newsletter_template-addf.php?id=<?php echo $line->id;?>" class="btn btn-primary" title="edit"> <i class="fa fa-pencil"></i></a>
			          </td>
                </tr>
				<?php $i++; }?>
