  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
	  ...
	  <div class="box-header" style="text-align:center">
               <?php if($_SESSION['sess_msg']){ ?><span class="box-title" style="font-size:12px;color:#a94442"><strong><?php echo $_SESSION['sess_msg'];$_SESSION['sess_msg']='';?></strong></span> <?php }?>
      </div>
      <ol class="breadcrumb">
		...
		<form name="frm" method="post" action="subscriber-del.php" enctype="multipart/form-data">
          <div class="box">
			...
			<div class="row">
				...
				<div class="col-md-3">
					<select name="news_temp" style="width:240px; height:30px; margin-bottom:10px;">
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php
				$i=1;
				$sql=$obj->query("select * from $tbl_newsletter where 1=1 order by id asc",$debug=-1);
